...
$"??_C@_02NBOLBAHI@9?6?$AA@" = comdat any

@"??_C@_02NBOLBAHI@9?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [3 x i8] c"9\0A\00", comdat, align 1
...
define dso_local i32 @main() #0 {
  ...
  %2 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_02NBOLBAHI@9?6?$AA@")
  ret i32 0
}
